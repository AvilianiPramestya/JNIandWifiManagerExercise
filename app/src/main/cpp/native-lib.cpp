...
Java_id_ac_ui_cs_mobileprogramming_aviliani_tutorial6_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_id_ac_ui_cs_mobileprogramming_aviliani_tutorial6_MainActivity_sendYourName(
        JNIEnv* env,
...
extern "C"
JNIEXPORT jobjectArray JNICALL Java_id_ac_ui_cs_mobileprogramming_aviliani_tutorial6_MainActivity_stringArrayFromJNI(JNIEnv *env, jobject jobj)
{
